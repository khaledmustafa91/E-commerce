            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class= {{ ($category == $oneCategory->id) ? "active" : "" }}><a href="/shop/{{$oneCategory->id}}">{{$oneCategory->name}}</a></li>
                        @endforeach
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="{{asset('img/product-img/'.$product->photos_url[0])}}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{asset('img/product-img/'. $product->photos_url[1])}}" alt="">
                            </div>
